...
void make_plots(){
  ...
  string plots_log_true[38] = {"mu_pt_Z", "mu_phi", "mu_eta", "Z_mass", "Z_mass_MET", "Z_mass_1b", "Z_y", "Z_eta", "Z_phi", "Z_pt",
			       ...
			       "deltaphi_Zb", "deltaeta_Zb", "mv1cweight", "pileup", "pileup_noweight"};
